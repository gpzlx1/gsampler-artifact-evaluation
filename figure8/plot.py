...
def draw_figure(input_path, yticks, lengend):
    system_seq = ["PyG", "CPU", "DGL", "gSampler"]
...
if __name__ == "__main__":
    draw_figure("ladies/outputs/result.csv", np.arange(0, 51, 10), True)
    draw_figure("asgcn/outputs/result.csv", np.arange(0, 51, 10), True)
    draw_figure("pass/outputs/result.csv", np.arange(0, 101, 20), True)
    draw_figure("shadowkhop/outputs/result.csv", np.arange(0, 31, 5), True)
