echo "====graphsage===="
echo "====livejournal===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/livejournal/lj_loop.gr --gmgraph=true --hmgraph=false --umgraph=false --sage --n=512 --ngpu=1 --peritr=1 --batchnum=947 1>>outputs/skywalker.log 2>>outputs/skywalker.err
echo "====products===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/ogbn_products/pr_loop.gr --gmgraph=true --hmgraph=false --umgraph=false --sage --n=512 --ngpu=1 --peritr=1 --batchnum=385 1>>outputs/skywalker.log 2>>outputs/skywalker.err
echo "====papers100m===="
...
echo "====deepwalk===="
echo "====livejournal===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/livejournal/lj_loop.gr --gmgraph=true --hmgraph=false --umgraph=false --rw=1 --k 1 --d 80 --n=1024 --ngpu=1  --batchnum=474 1>>outputs/skywalker.log 2>>outputs/skywalker.err
echo "====products===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/ogbn_products/pr_loop.gr --gmgraph=true --hmgraph=false --umgraph=false --rw=1 --k 1 --d 80 --n=1024 --ngpu=1  --batchnum=193 1>>outputs/skywalker.log 2>>outputs/skywalker.err
echo "====papers100m===="
...
echo "====livejournal===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/livejournal/lj_loop.gr --gmgraph=true --hmgraph=false  --node2vec --rw=1 --k 1 --d 80 --n=1024 --ngpu=1  --batchnum=474 1>>outputs/skywalker.log 2>>outputs/skywalker.err
echo "====products===="
skywalker/build/skywalker --bias=0 --ol=1 --input /home/ubuntu/dataset/ogbn_products/pr_loop.gr --gmgraph=true --hmgraph=false  --node2vec --rw=1 --k 1 --d 80 --n=1024 --ngpu=1 --batchnum=193 1>>outputs/skywalker.log 2>>outputs/skywalker.err
