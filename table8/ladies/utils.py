...
def load_npz(dataset: str):
    dir_name = dataset
    if dir_name.startswith('ogbn'):
        dir_name = dir_name.replace('-', '_')
    adj = sp.load_npz("/home/ubuntu/dataset/{}/{}_adj.npz".format(dir_name, dataset))
    data = np.load("/home/ubuntu/dataset/{}/{}.npz".format(dir_name, dataset))
    return adj, data['train_index']
...
def load_data(dataset_str):
    ...
    return np.array(edges), features.shape[0], idx_train
